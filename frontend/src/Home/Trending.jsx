      ...
      <Carousel responsive={responsive}>
        {blogs && blogs.length > 0 ? (
          blogs.slice(0, 8).map((element) => {
            return (
              <div key={element._id} className='p-4 bg-pink-300 border border-gray-400 rounded-lg shadow-md mx-2'>
                <Link to={`/blog/${element._id}`}>
                  ...
                  <div className='p-4 bg-pink-200 rounedd-b-lg h-25 flex flex-col justify-between'>
