      ...
      <div className="min-h-screen flex items-center justify-center bg-pink-300 ">
        <div className="w-full max-w-md bg-pink-200 shadow-md rounded-lg p-8 mt-2">
          <form onSubmit={handleRegister}>
            ...
            <div className='mb-4'>
              <input type="text" placeholder="Your Name" value={name} onChange={(e) => setName(e.target.value)} className="w-full  mb-4 p-2 border rounded-md bg-pink-100" />
              ...
              <input type="number" placeholder="Your Phone Number" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full mb-4 p-2 border rounded-md bg-pink-100" />
              ...
              <select value={education} onChange={(e) => setEducation(e.target.value)} className="w-full p-2 mb-4 border rounded-md bg-pink-100">
              ...
              <p className="text-center mb-4">Already Registered? <Link to={'/login'} className="text-pink-600">Login</Link></p>
              <button type="submit" className="w-full p-2 bg-pink-500 hover:bg-pink-800 duration-300 rounded-md text-white">Register</button>
            </div>
          </form>
        </div>
      </div>
