...
function Creators() {
  ...
  return (
    <div className='flex flex-wrap justify-center items-center my-20 bg-pink-200'>{creators.map((creator)=>(
      <div key={creator._id} className='bg-pink-300 shadow-lg rounded-lg overflow-hidden max-w-xs w-full m-2'>
