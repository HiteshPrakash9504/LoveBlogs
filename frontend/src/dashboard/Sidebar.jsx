...
function Sidebar({setComponent}) {
    ...
    return (
        <>
            ...
            <div className={`w-64 h-full shadow-lg fixed top-0 left-0 bg-pink-200 transition-transform duration-300 transform sm:translate-x-0 ${show ? "translate-x-0" : "-translate-x-full"} `}>
